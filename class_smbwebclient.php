...
# ! Modified by Guy Thomas 2007 - 2009 !
# ! all deprecated ereg functions replaced with preg functions by
# ! Jon Witts 2010090700 !
#
...
var $inlineFiles = array (
    ...
    'style/page.thtml' => '',
 ...
 * @param null|string $setMimeType - if this is passed in as a string it will force the mime type to this value (GT MOD - 2009080300)
 */
function DumpFile($file='', $name='', $isAttachment=false, $isCacheable=false, $setMimeType=null)
{
    ...
    // GT MOD 2008-06-19 - Set mime type to force download
    if ($isAttachment && !stripos($_SERVER['HTTP_USER_AGENT'], 'Firefox')){
...
# HTML a href
// GT Mod - add class, style and script parameters
function Link ($title, $url='', $name='', $class='', $style='', $onclick='')
{
    $att_class=$class=='' ? '' : ' class ="'.$class.'" ';
    $att_style=$style=='' ? '' : ' style ="'.$style.'" ';
    $att_onclick=$onclick=='' ? '' : ' onclick ="'.$onclick.'" ';
    if ($name <> '') $name = "name = \"{$name}\"";
    return ($url == '') ? $title : "<a".$att_class.$att_style.$att_onclick." href=\"{$url}\" {$name}>{$title}</a>";
}
...
{    
    ...
    foreach ($this->results as $file => $data) {
        ...
        // GT Mod - removed image icon for file types - use css instead
        // $icon = $this->Icon($data['type']);
        $comment = @$data['comment'];
        if ($data['type'] <> 'printjob') {
            // GT Mod - add file class into link
            $fileclass=$ftype=='file' ? 'file ext_'.strtolower($pi['extension']) : 'folder';
            // GT Mod - add script to prevent file direct download for Microsoft Internet Explorer, MS office formats
            // This basically protects users from opening rather than downloading an office file.
            // Opening an office file via internet explorer opens it in 'temporary internet files'.
            // Some users then save the file and then can't recover it because its in an unexpected folder on the local machine.
            $onclick='';
            if (isset($this->cfgIEProtectMsOffice) && $this->cfgIEProtectMsOffice && strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE')){
                $msexts=array('xls', 'doc', 'ppt', 'mdb', 'docx', 'docm','dotx','dotm','xlsx','xlsm','xltx','xltm','xlsb','xlam','pptx','pptm','potx','potm','ppam','ppsx','ppsm','accdb','accde','accdt','accdr');
                if (in_array(strtolower($pi['extension']), $msexts)){
                    $onclick='alert (\'To download this file, please right hand click it and select &#34;Save Target As&#34;\'); return false;';
                }
            }
            $filelink = $this->Link(htmlentities($file, ENT_COMPAT, $this->cfgDefaultCharset), $this->FromPath($file), '', $fileclass, '', $onclick);
        }
        $lines .= "<tr>".
        "<td class=\"checkbox\">{$check}</td>".
        "<td {$style['Name']}><nobr>{$filelink}</nobr></td>".
...
{
    $this->Debug('compress');
    // GT Mod 2009080300 - set the size property to the maximum allowed zip file size when downloading folders as zips
    if (isset($this->cfgMaxFolderZipSizeMB)){
        $sizebytes=($this->cfgMaxFolderZipSizeMB*1024)*1024;
        $this->size=$sizebytes; // set maximum size in bytes
    } else {
        $this->size=0; // setting the size to 0 means the size header gets excluded
    }
    $this->DumpFile('', $this->name.'.'.$this->cfgArchiver, false, false, 'application/x-forcedownload'); // GT MOD 2009080300 - force download mime type (otherwise some reverse proxy servers will just die at this point and output a zip file of 0kb)
...
{
    $image = $this->Image($this->cfgBaseUrl."/style/{$icon}.png",'#',"align=\"absmiddle\" width=\"$size\" height=\"$size\"");
...
function _Get ()
{
    ...
    if ($this->status == '') {
        ...
        if (! $this->cfgCachePath) {
            ...
            $this->DumpFile ($this->tempFile, $this->name, $this->cfgForceDownloads); // GT MOD 2008-06-19, added $this->cfgForceDownloads parameter
        }
    }
}
...
function _SmbClient ($command='', $path='', $message='', $dumpFile=false)
{
    ...
    if ($this->user <> '') {
        # not anonymous
        // GT MOD 2008080500 - prefix user name with config variable
        $username=$this->user;

        if (isset($this->cfgUserPrefix) && $this->cfgUserPrefix!=''){
            // GT MOD 2009031700 - only add prefix in if its not already there
            $escUserPrefix=str_replace('/','\/',$this->cfgUserPrefix); // escape forward slash userPrefix
            $pattern='/^'.$escUserPrefix.'/';
            if (!preg_match($pattern, $username)){
                $username=$this->cfgUserPrefix.$username;
            }
        }

        if (strtolower($this->cfgWebserverType)=='windows'){
            $this->cfgAuthMode='SMB_AUTH_ARG_WIN';
        }

        switch ($this->cfgAuthMode) {
            case 'SMB_AUTH_ENV': putenv('USER='.$username.'%'.$this->pw); break;
            case 'SMB_AUTH_ARG': $smbcmd .= ' -U '.escapeshellarg($username.'%'.$this->pw);
            case 'SMB_AUTH_ARG_WIN': $smbcmd .= ' -U '.'"'.str_replace('"','\"',$username.'%'.$this->pw).'"';
        }
    }
    $cmdline = $this->cfgSmbClient.' '.$smbcmd.' '.$options;

    // Fix Ubuntu 8.10 smbclient bug
    // Skip no password prompt parameter (-N) if $this->cfgSkipNoPwdParam=true
    if (!isset($this->cfgSkipNoPwdParam) || !$this->cfgSkipNoPwdParam){
        $cmdline.=' -N ';
    }
    ...
    // Fix supplied by Roy Gore 2010033100 - added spaces before 2>
...
function _ParseSmbClient ($cmdline, $dumpFile=false, $attempt=0)
{
    ...
    foreach (preg_split('/\n/', $output) as $line) if ($line <> '') {
        ...
        switch ($lineType) {
            ...
            case 'LOGON_FAILURE':
            case 'ACCESS_DENIED' : return($this->_RetryParse($cmdline, $dumpFile, $attempt)); break;

            // GT MOD 2009021600 - added check for object name / path not found. Without this an invalid path will cause an infinite redirect loop!
            case 'OBJECT_NAME_NOT_FOUND' : $this->_ErrorFilePathNotFound ('Error: OBJECT_NAME_NOT_FOUND - ', $cmdline); break;
            case 'OBJECT_PATH_NOT_FOUND' : $this->_ErrorFilePathNotFound ('Error: OBJECT_PATH_NOT_FOUND - ', $cmdline); break;
...
# GT MOD 20090216
# Debug - Report path or file not found
function _ErrorFilePathNotFound($error, $cmdline){
    $path=$this->_CmdLineGetPath($cmdline);
    $this->debug($error.' '.$path.' '.$cmdline);
    $this->ErrorMessage($error.' '.$path);
}

# GT MOD 2009021600
# Get path from smbclient command line
function _CmdLineGetPath($cmdline){
    $exp=explode (' ', $cmdline);
    $path='';
    $usenext=false;
    foreach ($exp as $e){
...
# GT MOD 2008080400
# Try parse again with username prefixed with 'workgroup/' (needed for shares on separate server to domain controller)
function _RetryParse ($cmdline, $dumpFile, $attempt){
    ...
    if ($this->cfgUserPrefix==$this->workgroup || $this->cfgUserPrefix==$this->workgroup.'/'){
        return; // exit if user prefix is the same as workgroup
    }

    // GT MOD 2009031700 - only add prefix in if its not already there
    $escworkgroup=str_replace('/','\/',$this->workgroup);
    $pattern='/^'.$escworkgroup.'/';
    if (preg_match($pattern, $this->user)==0){
        $tryuser=$this->workgroup.'/'.$this->user;
    } else {
        $tryuser=$this->user;
    }
    ...
    if ($this->user <> '') {
        switch ($this->cfgAuthMode) {
            case 'SMB_AUTH_ENV': putenv('USER='.$tryuser.'%'.$this->pw); break;
            case 'SMB_AUTH_ARG': $smbcmd .= ' -U '.escapeshellarg($tryuser.'%'.$this->pw);
        }
    }

    $cmdline=str_replace(   ' -U '.escapeshellarg($this->user),
...
function _ParseTime ($m, $d, $y, $hhiiss)
{
    ...
    return mktime(intval($his[0]), intval($his[1]), intval($his[2]), intval($im), intval($d), intval($y));
}
